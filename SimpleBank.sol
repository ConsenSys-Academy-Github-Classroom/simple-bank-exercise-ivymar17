...
contract SimpleBank {
    ...
    function deposit() public payable returns (uint) {
      ...
      // 2. Users should be enrolled before they can make deposits
        require(enrolled[msg.sender] == true, "User not a bank customer. You must enroll first");
    ...
    function withdraw(uint withdrawAmount) public payable returns (uint) {
      ...
      require(balances[msg.sender] >= withdrawAmount, "Not enough money to withdraw");
